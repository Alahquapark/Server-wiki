    ...
    echo "
        ...
        <body>
            <div class='w3-bar w3-black w3-card'>
                ...
                <a href='laburpena.php' class='w3-bar-item w3-button w3-padding-large w3-hide-small'>LABURPENA</a>

                <div class='w3-dropdown-hover w3-hide-small'>
                    <button class='w3-padding-large w3-button' title='More'>TUTORIALA <i class='fa fa-caret-down'></i></button>
                    <div class='w3-dropdown-content w3-bar-block w3-card-4'>
                        <a href='rekisitoak.php' class='w3-bar-item w3-button'>Rekisito minimoak</a>
                ...
                <a href='bideoa.php' class='w3-bar-item w3-button w3-padding-large w3-hide-small'>BIDEOA</a>
